...
def crawl_articles_by_tag(tag: str, max_records: int = None, type_crawl: str = 'incremental'):
    ...
    if not articles_data:
        ...
        object_key = f'web_crawler/cointelegraph/{tag}/cointelegraph_{tag}_{type_crawl}_crawled_at_{date.today()}.json'
